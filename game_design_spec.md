...
*   **Enemies & Combat:** The visual design of the enemies is *not* tied to the length of the word they carry. Enemies are drawn as sleek, dark multi-layered dreadnoughts with swept-back wings, glowing red cockpit cores, neon wing-vents, and flickering orange/white gradient exhaust trails.
    ...
    *   **The Final Boss Mechanic:** At the end of the final round (Round 3 for < 70 WPM, Round 4 for >= 70 WPM), a massive "Boss" ship spawns. Instead of each word being a separate ship, the entire final sentence (or two) of the story belongs to this single Boss. As the player types the words, they systematically deal damage to the Boss's health pool to win the game!
        *   **Dynamic Encounters:** The boss encountered is dynamically selected based on the player's WPM. Slow/Medium typers face the **Cybernetic Dreadnought** (Tech mechanics: QTE Core Obliteration Laser dealing 5 damage/sec, Turret Bullet Hell, menacing sweeping strafe, massive stealth-bomber chassis with pulsing cyan exhaust). Fast/Very Fast typers face the **Abyssal Bio-Entity** (Organic mechanics: Spinning Toxic Danmaku, QTE Beam Attack dealing 10 damage/sec, Black Hole Spaghettification death). For both bosses, taking beam damage strictly halts the player's passive shield regeneration. The QTE warning UI is clustered to the right side of the boss to prevent vertical screen clipping.
