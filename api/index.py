...
def check_rate_limit(client_ip: str):
    ...
    requests = [req_time for req_time in RATE_LIMIT_STORE[client_ip] if now - req_time < RATE_LIMIT_WINDOW_SECONDS]
...
async def generate_narrative_endpoint(request: Request, state: GameState):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="The Game Master encountered an internal error. Please try again.")
