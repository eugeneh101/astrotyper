...
def evaluate():
    print("Testing Round 1 Generation (Seeds)...")
    # Simulate Round 1
    res1: GameMasterResponse = generate_narrative("", 100, 60, 1)
    ...
    print("Testing Round 2 Generation (Branching)...")
    story_so_far = res1.branches[0].full_narrative
    res2: GameMasterResponse = generate_narrative(story_so_far, 100, 80, 2)
    ...
    res_death: GameMasterResponse = generate_narrative(story_so_far, 0, 80, 2)
